...
export interface CustomInstanceCommands<T> {
     ...
     */
    addLocatorStrategy<IsElement extends boolean = false>(name: string, func: IsElement extends true ? (selector: string, root: HTMLElement) => CustomLocatorReturnValue : (selector: string) => CustomLocatorReturnValue): void;
}
